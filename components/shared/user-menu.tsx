    ...
    <DropdownMenu>
      <DropdownMenuTrigger className="outline-none">
        <Avatar className="h-9 w-9 cursor-pointer bg-primary">
          ...
          <AvatarFallback className="bg-primary text-white text-[13px] font-bold">{initials}</AvatarFallback>
        </Avatar>
      </DropdownMenuTrigger>
        ...
        <div className="px-4 pt-3.5 pb-3 border-b border-[#F0EDE6] dark:border-border">
          ...
          {isPro ? (
            <div className="flex items-center justify-between rounded-lg bg-[#F7F5F0] dark:bg-muted px-2.5 py-2">
              ...
              <span className="rounded-full bg-primary px-2 py-0.5 text-[9px] font-bold text-white">Active</span>
            </div>
          ) : (
            <button onClick={() => openUpgradeModal("generic")} className="block w-full text-left">
              <div className="flex items-center justify-between rounded-lg bg-primary px-3 py-2.5 hover:opacity-90 transition-opacity cursor-pointer">
                <div>
                  <p className="text-[11px] font-semibold text-white">Upgrade to Pro</p>
                  <p className="text-[10px] text-accent mt-0.5">Unlimited &middot; Cancel anytime</p>
                </div>
