...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      "en-AE": "https://www.thecvedge.com/cv-review/gcc",
      "en-SA": "https://www.thecvedge.com/cv-review/gcc",
      "en-QA": "https://www.thecvedge.com/cv-review/gcc",
      "en-KW": "https://www.thecvedge.com/cv-review/gcc",
      "x-default": "https://www.thecvedge.com/cv-review/gcc",
    },
  },
  openGraph: {
...
const breadcrumbJsonLd = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "GCC", "item": "https://www.thecvedge.com/cv-review/gcc" },
  ],
};

const GCC_COUNTRIES = [
  { name: "UAE & Dubai", href: "/cv-review/uae", description: "ADNOC, Emirates Group, Mubadala, Noon, Careem", color: "#1a7a6d" },
  { name: "Saudi Arabia", href: "/cv-review/saudi-arabia", description: "ARAMCO, STC, NEOM, PIF portfolio companies", color: "#1E3A5F" },
  { name: "Qatar", href: "/cv-review/new", description: "QatarEnergy, Qatar Airways, Ooredoo, Hamad Medical", color: "#065F46" },
  { name: "Kuwait", href: "/cv-review/new", description: "KPC, NBK, Zain, Agility, Gulf Bank", color: "#5B21B6" },
  { name: "Bahrain", href: "/cv-review/new", description: "BAPCO, Gulf Air, Arab Banking Corporation, Batelco", color: "#92400E" },
  { name: "Oman", href: "/cv-review/new", description: "PDO, OQ, Oman Air, BankMuscat, Nawras", color: "#0C4A6E" },
];

export default function CvReviewGccPage() {
  return (
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-extrabold tracking-tight mb-4">
              Choose your GCC market
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Each GCC country has its own hiring norms, ATS preferences, and employer landscape. Your reviewer will be matched to your target market.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {GCC_COUNTRIES.map((c) => (
              <Link
                key={c.name}
                href={c.href}
                className="rounded-2xl p-6 relative overflow-hidden group transition-transform hover:-translate-y-0.5"
                style={{ backgroundColor: c.color }}
              >
                <div className="absolute -top-5 -right-5 w-20 h-20 rounded-full bg-white/5" />
                <div className="relative">
                  <h3 className="text-lg font-extrabold text-white mb-2">{c.name}</h3>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 items-start">
            <div className="bg-card border border-border/80 rounded-2xl p-7 flex flex-col">
              ...
              <CvReviewCtaTracker ctaName="gcc_pricing_review">
            ...
            <div className="bg-primary text-primary-foreground rounded-2xl p-7 flex flex-col relative">
              ...
              <p className="text-sm mb-5" style={{ color: "rgba(255,255,255,0.65)" }}>Full rewrite by a GCC specialist</p>
              ...
              <ul className="space-y-3 mb-8 flex-1 text-sm">
                {["Full CV rewrite for your GCC market", "ATS keyword optimization", "80+ ATS score guarantee", "3–5 revisions included", "PDF + Word export"].map((f, i) => (
              ...
              <CvReviewCtaTracker ctaName="gcc_pricing_rewrite">
                <Link href="/cv-review/new?plan=rewrite" className="w-full flex justify-center items-center bg-white hover:bg-white/90 text-primary px-5 py-3.5 rounded-xl font-bold text-sm transition-colors">Get GCC Rewrite</Link>
              </CvReviewCtaTracker>
            </div>
            ...
            <div className="rounded-2xl p-7 flex flex-col" style={{ backgroundColor: "#1E3A5F" }}>
              ...
              <CvReviewCtaTracker ctaName="gcc_pricing_executive">
          ...
          <div className="bg-primary text-primary-foreground rounded-3xl p-12 md:p-16 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-5xl font-extrabold mb-5 leading-[1.1] tracking-tight">
                Get your CV GCC-ready in 24 hours.
              </h2>
              <p className="text-lg mb-8 max-w-xl mx-auto font-medium" style={{ color: "rgba(255,255,255,0.8)" }}>
                Stop losing GCC opportunities to ATS filters. A dedicated regional specialist will fix it today.
              </p>
              <CvReviewCtaTracker ctaName="gcc_footer_primary">
              ...
              <div className="flex flex-wrap justify-center gap-8 mt-10 text-sm font-bold" style={{ color: "rgba(255,255,255,0.8)" }}>
                ...
                <span className="flex items-center gap-2"><Check className="w-4 h-4" /> One-time payment</span>
              </div>
            </div>
          </div>
        </div>
