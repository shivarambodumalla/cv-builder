...
export default function HomePage() {
  return (
    <>
          ...
          <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-3">
            <div className="relative rounded-xl border bg-background p-6 text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Drop your PDF or paste your text. Our AI parses every section including experience, education, skills, and certifications in seconds.
              </p>
            </div>
            <div className="relative rounded-xl border bg-background p-6 text-center">
      ...
      {/* ─── FEATURES GRID ─── */}
      <section id="features" className="bg-muted/30 scroll-mt-16">
        <div className="container mx-auto px-4 py-20 md:py-28">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
