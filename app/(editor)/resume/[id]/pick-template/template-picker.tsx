...
const TEMPLATES: Template[] = [
  ...
  { name: "Classic Serif", slug: "classic-serif", img: "/img/templates/classic-serif.jpg", category: ["all", "single", "professional"], type: "Single column", desc: "Elegant serif typography with grey section bands. ATS-safe. Traditional and timeless.", tags: [] },
